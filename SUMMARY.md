...
* [옵저버 패턴 Observer Pattern](design-pattern/observer-pattern.md)
* [데코레이터 패턴 Decorator Pattern](design-pattern/decorator-pattern.md)
* [팩토리 패턴 - 팩토리 메소드 & 추상 팩토리](design-pattern/and.md)
* [싱글턴 패턴 Singleton Pattern](design-pattern/singleton-pattern.md)
* [커맨드 패턴 Command Pattern](design-pattern/command-pattern.md)
* [어댑터 패턴 Adapter Pattern](design-pattern/adapter-pattern.md)
* [퍼사드 패턴   Fecade Pattern](design-pattern/fecade-pattern.md)
...
* [Activities](android-doc-1/activities/README.md)
  * [Introduction to Activities](android-doc-1/activities/introduction-to-activities.md)
...
* [2장 의미있는 이름](clean-code/2.md)
* [3장 함수](clean-code/3.md)
* [4장 주석](clean-code/4.md)
* [5장 형식 맞추기](clean-code/5.md)
* [6장 객체와 자료구조](clean-code/6.md)
* [11장 시스템](clean-code/11.md)
* [12장 창발성](clean-code/12.md)
* [13장 동시성](clean-code/13.md)
* [14장 점진적 개선](clean-code/14.md)
* [17장 냄새와 휴리스틱](clean-code/17.md)
* [부록 - 동시성](clean-code/undefined.md)
